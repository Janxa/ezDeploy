		...
		<main className="mt-28 md:mt-32 w-11/12 m-auto flex  flex-col">
			...
			<div className="bg-flat-700 flex flex-col h-full   w-4/5  md:w-1/2 lg:w-11/12  overflow-hidden  mx-auto p-4 shadow-md rounded-md">
				...
				<p className="mt-4">
					...
					<ul>
						...
						<li className="mt-4">
							<b className="text-chili-200">Contact Form:</b> The app includes a
							fully functional contact form, allowing users to easily get in
							touch with me for any inquiries or feedback they may have.
						</li>
						<li className="mt-4">
							<b className="text-chili-200">Scalability with Celery:</b> By
						...
						<li className="mt-4">
							<b className="text-chili-200">MySQL Database:</b> User's data are
							stored in a MySQL Database powered by the sqlAlchemy ORM.
						</li>
						<li className="mt-4">
							<b className="text-chili-200">Real-Time Notifications:</b> To keep
							users informed about the uploading process, the server sends
							real-time notifications using Server-Sent Events (SSE). This
							feature allows users to stay updated on the progress of their
							uploads.
						</li>
						<li className="mt-4">
							<b className="text-chili-200">Enhanced Authentication: </b> JWT
						...
						<li className="mt-4">
							<b className="text-chili-200">Responsive: </b> Even though the app
							isn't meant to be used on mobile devices, you can still access all
							of its features on your phone through its responsive design.
						</li>
					</ul>
				</p>
			</div>
			<div className="bg-flat-700 flex flex-col h-full mt-4  w-4/5  md:w-1/2 lg:w-11/12  overflow-hidden  mx-auto p-4 shadow-md rounded-md">
				<p className="">
					...
					<b className="ml-1 text-chili-300 ">
					...
					<a
						...
						className="text-chili-300 underline font-medium"
					>
						{" "}
