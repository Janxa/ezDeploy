...
function Menu({visible,setVisible}) {
    ...
    <div className={visible
        ? 'flex flex-col items-center absolute top-16 left-0 w-full h-screen z-50 md:flex md:w-2/3 md:justify-between text-white md:font-medium md:static md:h-full bg-color-bg-dark pt-4'
        ...
        <ul className=" flex flex-col md:items-center md:flex-row-reverse md:justify-between w-3/4 md:w-full">
            <li className="flex mb-4 md:mb-0  basis-1/4 w-1/2 md:w-auto justify-around self-center">
                <Link onClick={() => setVisible(!visible)} className="p-2 mx-1 rounded-md bg-color-blue-primary"
